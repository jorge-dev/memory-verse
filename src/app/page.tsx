...
const timelineEvents = [
  {
    ...
    description: "The day that changed everything when we first met at the coffee shop."
  },
  {
    date: "December 2013",
    title: "First Date",
    description: "Our magical first date at the local park, followed by dinner."
  },
  {
    date: "February 2014",
  ...
  },
  {
    date: "September 2016",
    title: "The Proposal",
    description: "A perfect sunset, a beautiful ring, and a 'Yes' that changed our lives."
  },
...
const loveReasons = [
  ...
  {
    title: "Your Kindness",
    description: "How you always think of others and spread joy wherever you go."
  },
  {
    title: "Your Support",
...
const memories = [
  {
    ...
    description: "Remember that spontaneous road trip to the beach? We got lost but found the most amazing sunset spot."
  },
  {
    id: 2,
    ...
    description: "You surprised me with matching ugly sweaters. I still have mine!"
  },
  {
    id: 3,
    ...
    description: "When we decided to grow our own vegetables. The tomatoes never made it, but our love grew stronger!"
  }
];
...
const footerData = {
  message: "To my beloved Rebekah, who makes every day of my life more beautiful than I could have ever imagined.",
  ...
  return (
    <main className="relative bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <HeroSection
        ...
        backgroundImage="https://picsum.photos/seed/hero193s/3840/2160.webp"
      />
